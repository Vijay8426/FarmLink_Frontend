    ...
    <div className="main-body">
            ...
            <div className="col-md-4 mb-3">
              <div className="card" data-aos="fade-up">
                <div className="card-body">
                  ...
                  <img 
        src="https://i.pinimg.com/originals/25/55/ad/2555add5a600ad8b5f72019fee870741.jpg" 
        alt="Admin" 
        width="200" 
        height="200" 
        style={{ 
      ...
      />
                    <div className="mt-3">
                      ...
                      <p className="text-muted font-size-sm">Bamban Palam , Tiruvallur</p>
                      <button className="btn btn-success w-100">Message</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="card mt-3" data-aos="fade-up">
              ...
              <div className="row gutters-sm">
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                    <div className="card-body">
                      <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-primary mr-2">Contracts Completed</i></h6>
                ...
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                    <div className="card-body">
                      <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-info mr-2">Contract in progress</i></h6>
                      <small>Web Design</small>
                      <div className="progress mb-3" style={{height: '5px'}}>
                        <div className="progress-bar bg-primary" role="progressbar" style={{width: '80%"'}} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
